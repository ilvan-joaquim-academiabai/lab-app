...
export function DataTable<TData, TValue>({
  ...
  return (
    <div>
      <div className="py-6">
        <h1 className="text-2xl font-bold">Editar [Designação da Escola]</h1>
      </div>
      ...
      <div className="flex items-center justify-end py-4 gap-x-6">
        <Button onClick={onSubmit} disabled={errors ? true : false} className="bg-blue-700 hover:bg-blue-600">
